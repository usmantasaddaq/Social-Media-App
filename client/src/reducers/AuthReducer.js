const authReducer = (state = { authData: null, loading: false, error: false, updateLoading: false, errorMessage: null }, action) => {
  ...
  switch (action.type) {
    ...
    case "AUTH_FAIL":
      return { ...state, loading: false, error: true, errorMessage: action.data.response.data };
    case "UPDATING_START":
